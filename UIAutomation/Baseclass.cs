...
using HP.Test.Automation.Helpers;
...
namespace HP.LR.Test.UIOperation
{
    ...
    public class ClassicBase
    {
        ...
        public class Emulation
        {
            ...
            /// <param name="x_offset">offset in X axis</param>
            /// <param name="y_offset">offset in Y axis</param>
            public static void RightClick(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);
            ...
            {
                var rect = element.Current.BoundingRectangle;
                //HP.Test.Automation.Helpers.MouseHelper.Click(Convert.ToInt32(rect.Width / 2), Convert.ToInt32(rect.Height / 2));
            ...
            /// <param name="x_offset">offset in X axis</param>
            /// <param name="y_offset">offset in Y axis</param>
            public static void MouseClick(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);
            ...
            public static void MouseClickByIndex(AutomationElement element, int index)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = (Convert.ToInt32(rect.Width)) / 2;
                int ypoint = (((Convert.ToInt32(rect.Height)) * index) + ((Convert.ToInt32(rect.Height)) / 2));
                MouseClick(element, xpoint, ypoint);
            }
            ...
            /// <param name="x_offset">offset in X axis</param>
            /// <param name="y_offset">offset in Y axis</param>
            public static void DoubleClick(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);
            ...
            /// <param name="x_offset">offset in X axis</param>
            /// <param name="y_offset">offset in Y axis</param>
            public static void MouseOver(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
            ...
            public static void MouseDown(AutomationElement element)
            {
                var rect = element.Current.BoundingRectangle;
                MouseDown(element, Convert.ToInt32(rect.Width / 2), Convert.ToInt32(rect.Height / 2));
            }

            public static void MouseDown(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);
                Console.WriteLine("MouseDown on X axis: {0}, and on Y axix {1}", xpoint, ypoint);
                MouseEmulate.Move(xpoint, ypoint);
                MouseEmulate.MouseDown(MouseButton.Left);
                Thread.Sleep(500);
            }

            public static void MouseUp(AutomationElement element)
            {
                var rect = element.Current.BoundingRectangle;
                MouseUp(element, Convert.ToInt32(rect.Width / 2), Convert.ToInt32(rect.Height / 2));
            }


            public static void MouseUp(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);
                Console.WriteLine("MouseUp on X axis: {0}, and on Y axix {1}", xpoint, ypoint);
                MouseEmulate.Move(xpoint, ypoint);
                Thread.Sleep(1000);
                MouseEmulate.MouseUp(MouseButton.Left);
            }

            public static void MouseMoveEmulationAndUp(AutomationElement element)
            {
                var rect = element.Current.BoundingRectangle;
                MouseMoveEmulationAndUp(element, Convert.ToInt32(rect.Width / 2), Convert.ToInt32(rect.Height / 2));
            }

            public static void MouseMoveEmulationAndUp(AutomationElement element, int x_offset, int y_offset)
            {
                var rect = element.Current.BoundingRectangle;
                int xpoint = Convert.ToInt32(rect.X + x_offset);
                int ypoint = Convert.ToInt32(rect.Y + y_offset);

                MouseMoveEmulationAndUp(xpoint, ypoint);
            }
            ...
            public static void KeyBoardEnter(string value)
            {
                if (!string.IsNullOrEmpty(value))
                {
                    ...
                    {
                        KeyboardEmulate.KeyPress((Keys)Enum.Parse(typeof(Keys), c.ToString()));
                    }
                    Thread.Sleep(500);
                }
            }

            public static void KeyBoardUp(Keys Key)
            {
                KeyboardEmulate.KeyUp(Key);
            ...
            public static void PressCombinationKeys(string combinationkey)
            {
                ...
                {
                    string[] ckeys = combinationkey.Split(new char[] { '+' });
                    for (int i = 0; i < ckeys.Length - 1; i++)
                    {
                        KeyboardEmulate.KeyDown((Keys)Enum.Parse(typeof(Keys), ckeys[i].ToString()));
                    }
                    ...
                    for (int i = 0; i < ckeys.Length - 1; i++)
                    {
                        KeyboardEmulate.KeyUp((Keys)Enum.Parse(typeof(Keys), ckeys[i].ToString()));
                    }
                }
            }
